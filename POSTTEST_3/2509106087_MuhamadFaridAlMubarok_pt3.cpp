...
int queue[MAKS_QUEUE];

int front = -1, rear = -1;
bool isFull() {
    return rear == MAKS_QUEUE - 1;
}
...
void enqueue(int value) {
    ...
    rear++;
    queue[rear] = value;
    cout << dataHewan[value].namaHewan << " Telah Dimasukkan Ke Dalam Antrian!" << endl;
...
int dequeue() {
    if (isEmpty()) {
        cout << "Antrian Kosong! Tidak Ada Pasien." << endl;
        return -1;
    }
    ...
    cout << "------------------" << endl; 
    cout << "ID Hewan   : " << dataHewan[value].idHewan;
    cout << "Nama Hewan : " << dataHewan[value].namaHewan;
...
void displayQueue() {
    ...
    for (int i = front; i <= rear; i++) {
        cout << i - front + 1 << ". " << dataHewan[queue[i]].namaHewan << endl <<
        "  " << "ID: " << dataHewan[queue[i]].idHewan;
    }
    cout << endl;
}
void jeda() {
...
void menuUtama() {
    ...
    do {
        ...
        cout << "|  [9]. Daftar Antrian Pasien          |" << endl;
        cout << "|  [10]. Panggil Pasien                |" << endl;
        cout << header << endl;
        cout << "Masukkan Opsi: ";
        cin >> pilihan;
        ...
        if (pilihan == "0") {
            ...
            if (nomorAntrian >= jumlahData) {
                cout << "Semua Data Sudah Ada Di Antrian!" << endl;
                jeda();
            } else {
                enqueue(nomorAntrian);
                nomorAntrian++;
            }
